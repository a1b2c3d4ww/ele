...
@section('title',$title)
  ...
  @section('content')              
        ...
        @endif
                             <form action="/admin/adver/{{$res->lid}}" method='post' class="mws-form" enctype='multipart/form-data'>
                        	<div class="mws-form-inline">
                            	...
                            	<div class="mws-form-row">
                                	...
                                	<div class="mws-form-item">
                                    	<input type="text" name='lname' class="small" value="{{$res->lname}}">
                                    </div>
                                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">轮播图片</label>
                    <div class="mws-form-item">
                        <img src="{{$res->lpic}}" alt="" width='180px' height='120px'>
