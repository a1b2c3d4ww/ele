...
<link rel="stylesheet" type="text/css" href="jui/admins/css/jquery.ui.all.css" media="screen">
        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-navigation">
                <ul>
                    ...
                    <li class="active"><a href="error.html"><i class="icon-warning-sign"></i> Error Page</a></li>
                    <li>
                        <a href="icons.html">
        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="container">
            	<div id="mws-error-page">
                    ...
                    <p><a href="dashboard.html">click here</a> to go back home</p>
                </div>
            </div>
            <!-- Inner Container End -->
