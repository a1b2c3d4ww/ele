                ...
                checkout-cart="cart">
                    <div class="checkoutcart-container">
                        ...
                        <dl ng-if="basket.length" ng-repeat="basket in cart.vm.group" class="checkoutcart-group ng-scope">
                            <dt ng-bind="$index + 1 + &#39;号购物车&#39;" class="checkoutcart-grouptitle ng-binding">
                                1号购物车
                            </dt>
                            ...
                            <dd ng-repeat="item in basket" class="ng-scope">
                                <div class="checkoutcart-tablerow">
                                    ...
                                    <div class="cell itemquantity">
                                        <button ng-click="cart.sub(item)">
                                            -
                                        </button>
                                        <input ng-model="item.quantity" ng-change="cart.update(item)" ng-blur="cart.blur(item)"
                                        class="ng-pristine ng-valid">
                                        <button ng-click="cart.add(item)">
                                            +
                                        </button>
                                    </div>
                                    <div class="cell itemtotal ng-binding" ng-bind="&#39;¥&#39; + (item.price * item.quantity | number:2)">
                                        ¥3.00
                                    </div>
                                </div>
                            </dd>
                ...
                <div class="checkout-content ng-scope">
                    ...
                    <div class="checkout-select">
                        ...
                        <div class="checkout-info">
                            ...
                            <div class="formselect ng-isolate-scope" id="send">
                                
                                <select name="" class="formselect-value ng-binding" style="width:90px">
                                    <option value="0">立即送达</option>
                                    <option value="1">30分钟内</option>
                                    <option value="2">一小时内</option>
                                </select>
                    ...
                    <div>
                        <a class="btn-stress btn-lg ng-binding ng-isolate-scope" href="/home/orderpay">
                            确认下单
                        </a>
