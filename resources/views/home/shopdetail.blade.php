...
<div class="shopmain clearfix container ng-scope">
    <div class="shopmenu ng-isolate-scope">
        <div class="shopmenu-main grid" style="margin-top: 0px;">           
                   ...
                   $('button[name=jia]').each(function(index,element){
                       ...
                       $(this).siblings().eq(1).val(arr[index]);
                        ...
                        flyer.fly({
                            ...
                            $('#jiesuan').html('<a href="/home/orderinfo" style="color:white;">去结算</a> >');
                            sum =0;       
                            // return gname;
            ...
            <style>
                .mine{border:0px;color:#666;font-size:13px;text-overflow:ellipsis;margin-left:0px;width:155px;height:28px;}
                .your{font-size:11px;color:#666;border:1px solid #ddd;margin-left:8px;text-align:center;width:40px;height:22px;}
                .her{border:0px;color:#666;margin-left:15px;color:#F17530;width:80px;height:28px;text-align:right;}
            </style>
            <script>
                 $('.carts').each(function(){
                    $(this).click(function(){
                ...
                var dia = `<div class="shop-cartbasket-tablerow ng-scope dia" style="line-height:45px;">
                                <input class="mine itemname" name="gname"  value ="">
                                    ...
                                    <input class="your count" name="cnt" value="">
                                
                                <input class="her price" name ="price" value="">
                            </div>`;
            ...
            <div class="ng-isolate-scope">
                    ...
                    <div class="shop-cartfooter">
                        ...
                        <button type="button" class="shop-cartfooter-checkout ng-binding disabled" disabled="disabled" id="jiesuan" onclick="jiesuan()">
